package at.mvgeboltskirchen.kroissma.mvgapp.rest.authentication;
...
public class AuthenticationTokenInfo {
    ...
    public boolean equals(Object o) {
        ...
        if (expireAt != null ? !expireAt.equals(that.expireAt) : that.expireAt != null) {
            return false;
        }
        if (validityDuration != null ? !validityDuration.equals(that.validityDuration)
            : that.validityDuration != null) {
            return false;
        }
        return overlapDuration != null ? overlapDuration.equals(that.overlapDuration)
            : that.overlapDuration == null;
