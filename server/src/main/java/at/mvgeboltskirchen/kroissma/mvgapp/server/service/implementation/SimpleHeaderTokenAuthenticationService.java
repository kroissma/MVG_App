...
import at.mvgeboltskirchen.kroissma.mvgapp.server.configuration.properties.AuthenticationConfigurationProperties;
...
public class SimpleHeaderTokenAuthenticationService implements HeaderTokenAuthenticationService {
    ...
    private static final Logger LOGGER = LoggerFactory
        .getLogger(SimpleHeaderTokenAuthenticationService.class);
