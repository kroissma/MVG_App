...
import at.mvgeboltskirchen.kroissma.mvgapp.client.rest.InfoRestClient;
...
public class AboutController {
    ...
    private void initialize() {
        ...
        labClientBuildTime
            .setText((buildTime != null) ? DATETIME_FORMATTER.format(buildTime) : "-");
        ...
        labClientCommitTime
            .setText((commitTime != null) ? DATETIME_FORMATTER.format(commitTime) : "-");
        ...
        labClientUptime
            .setText(formatDuration(Duration.of(runtimeMXBean.getUptime(), ChronoUnit.MILLIS)));
            ...
            protected void succeeded() {
                ...
                if (info != null) {
                    ...
                    if (git != null) {
                        ...
                        if (build != null) {
                            labServerVersion
                                .setText((build.getVersion() != null) ? build.getVersion() : "-");
                            labServerBuildTime
                                .setText((build.getTime() != null) ? DATETIME_FORMATTER.format(
                                    build.getTime().withZoneSameInstant(ZoneId.systemDefault())
                                        .toLocalDateTime()) : "-");
                        }
                        ...
                        if (commit != null) {
                            ...
                            labServerCommitTime
                                .setText((commit.getTime() != null) ? DATETIME_FORMATTER.format(
                                    commit.getTime().withZoneSameInstant(ZoneId.systemDefault())
                                        .toLocalDateTime()) : "-");
                        }
                        String branch = git.getBranch();
                        labServerBranch
                            .setText((branch != null && !branch.isEmpty()) ? branch : "-");
        ...
        ticketlineInfoController
            .setBuildDateTime((buildTime != null) ? buildTime : LocalDateTime.now());
